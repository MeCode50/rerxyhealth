...
var create_appointment_controller_1 = require("../controllers/appointment/create_appointment_controller");
//import cron from "node-cron";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, create_appointment_controller_1.completedAppointment)()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                console.error("Error in scheduler:", error_1);
                return [3 /*break*/, 3];
