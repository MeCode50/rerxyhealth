...
const getAllDoctors_1 = require("../controllers/doctors/getAllDoctors");
const router = express_1.default.Router();
// onboarding
router.post('/doctor/signup', doctor_auth_1.signupDoctor);
router.post('/doctor/login', doctor_auth_1.signinDoctor);
// get all doctors 
router.get('/doctors', getAllDoctors_1.getAllDoctors);
router.get('/doctors/:id', getAllDoctors_1.getDoctorById);
//appointment
