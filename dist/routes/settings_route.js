...
router.put("/settings/update_password", isAuthenticated_1.authenticateUser, update_password_1.default);
router.put("/settings/update_number", isAuthenticated_1.authenticateUser, update_phone_number_1.default);
